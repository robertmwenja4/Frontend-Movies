        ...
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              <!-- Content -->
              <h6 class="text-uppercase fw-bold">Robaranks Movies</h6>
              <hr
                  class="mb-4 mt-0 d-inline-block mx-auto"
                  style="width: 60px; background-color: #7c4dff; height: 2px"
                  />
              <p>
                To view interesting, entertaining and latest movies
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="#!" class="text-white">Latest</a>
              </p>
              <p>
                <a href="#!" class="text-white">Action</a>
              </p>
              <p>
                <a href="#!" class="text-white">Thriller</a>
              </p>
            </div>
            <!-- Grid column -->
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <hr
                  ...
                  style="width: 60px; background-color: #7c4dff; height: 2px"
                  />
              <p><i class="fas fa-home mr-3"></i> Nairobi, Makadara, Jogoo Road</p>
              <p><i class="fas fa-envelope mr-3"></i> info@example.com</p>
              <p><i class="fas fa-phone mr-3"></i> + 254 234 567 88</p>
              <p><i class="fas fa-print mr-3"></i> + 254 234 567 89</p>
            </div>
            <!-- Grid column -->
          </div>
          <!-- Grid row -->
